...
def convert_response_to_dataframe(response):
    try:
        ...
        return {'df':df['ticker'],'next_url':json_data['next_url']}
    except Exception as e:
...
def save_dataframe_to_sheets(df):
    try:
        ...
        creds = Credentials.from_service_account_file('stocks-439709-b69ac4781e44.json', scopes=SCOPES)
